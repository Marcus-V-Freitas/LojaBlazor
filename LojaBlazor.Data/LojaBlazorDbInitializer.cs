namespace LojaBlazor.Data
{
    ...
    public class LojaBlazorDbInitializer : IInicializador
    {
        private readonly LojaBlazorDbContext db;
        private readonly UserManager<Usuario> userManager;
        private readonly RoleManager<Role> roleManager;
        private readonly IEnumerable<IDadosInicial> initialDataProviders;

        public LojaBlazorDbInitializer(
            LojaBlazorDbContext db,
            UserManager<Usuario> userManager,
            RoleManager<Role> roleManager,
            IEnumerable<IDadosInicial> initialDataProviders)
        {
            this.db = db;
        ...
        public void Inicializar()
        {
            ...
            {
                if (this.DataSetIsEmpty(initialDataProvider.TipoEntidade))
                {
                    var data = initialDataProvider.RecuperarDados();
        ...
        private void AddAdministrator()
            => Task
                .Run(async () =>
                {
                    ...
                    var adminRole = new Role(AdministratorRole);
                    ...
                    var adminUser = new Usuario
                    {
                        PrimeiroNome = "Admin",
                        Sobrenome = "Admin",
                        Email = "admin@lojablazor.com",
                        UserName = "admin@lojablazor.com",
