namespace LojaBlazor.Services
{
    ...
    internal abstract class Especificacao<T>
        where T : class
    {
        ...
        public Especificacao<T> And(Especificacao<T> specification)
        {
        ...
        public Especificacao<T> Or(Especificacao<T> specification)
        {
            if (!specification.Include)
            {
                return this;
        ...
        public static implicit operator Expression<Func<T, bool>>(Especificacao<T> specification)
            => specification.Include
                ? specification.ToExpression()
                : value => true;

        private class BinarySpecification : Especificacao<T>
        {
            private readonly Especificacao<T> left;
            private readonly Especificacao<T> right;
            private readonly bool andOperator;

            public BinarySpecification(Especificacao<T> left, Especificacao<T> right, bool andOperator)
            {
                this.right = right;
                this.left = left;
