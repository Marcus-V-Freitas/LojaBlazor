namespace LojaBlazor.Web.Server.Infrastructure.Extensions
{
    ...
    using LojaBlazor.Services.Common;
    using Data;
    ...
    public static class ServiceCollectionExtensions
    {
        ...
        public static IServiceCollection AddDatabase(
            ...
            IConfiguration configuration)
            => services
                .AddDbContext<LojaBlazorDbContext>(options => options
                    .UseSqlServer(configuration.GetDefaultConnectionString()))
                .AddTransient<IDadosInicial, CategoriasDados>()
                .AddTransient<IDadosInicial, ProdutosDados>()
                .AddTransient<IInicializador, LojaBlazorDbInitializer>();

        public static IServiceCollection AddIdentity(this IServiceCollection services)
        {
            services
                .AddIdentity<Usuario, Role>(options =>
                {
                    options.Password.RequiredLength = TamanhoMinSenha;
                ...
                .AddEntityFrameworkStores<LojaBlazorDbContext>();
